...
Open `index.html` through a local server to see a marker-based AR Christmas tree built with three.js + AR.js (THREEx marker tracking).

## Quick start

- Install any static server (if you have Node): `npx serve .`
- Or with Python: `python -m http.server 8080`
- Visit the served URL on your phone; allow camera access (the webcam feed sits behind the transparent canvas).
...
- Preview image to print/show: `pattern-2.png` - this is the marker the camera should see
